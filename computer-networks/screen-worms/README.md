...
Przy przetwarzaniu sieciowych danych binarnych należy używać typów o ustalonym rozmiarze: [http://en.cppreference.com/w/c/types/integer](http://en.cppreference.com/w/c/types/integer).
